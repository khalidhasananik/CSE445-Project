...
# Load the Excel file
input_file = 'dengue23.xlsx'  # Replace with your actual Excel file path
...
sheet_dates = generate_dates("31-12-23", len(excel_file.sheet_names))

# sheet_dates = generate_dates("31-12-21", 2)
